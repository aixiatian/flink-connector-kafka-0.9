...
public class Kafka09Fetcher<T> extends AbstractFetcher<T, TopicPartition> {
    ...
    private final SerializedValue<WatermarkStrategy<T>> watermarkStrategy09;
    ...
    public Kafka09Fetcher(
        ...
        this.watermarkStrategy09 = watermarkStrategy;
...
//                        emitRecord(kafkaCollector.getRecords().element(), partition, record.offset(), record);
                        emitRecordsWithTimestamps(kafkaCollector.records,partition,record.offset(),Long.MAX_VALUE);
    ...
    protected void emitRecord(T record, KafkaTopicPartitionState<T,TopicPartition> partitionState, long offset) throws Exception {
        ...
        if (record != null) {
                ...
                synchronized (checkpointLock) {
                    sourceContext.collectWithTimestamp(record, Long.MAX_VALUE);
