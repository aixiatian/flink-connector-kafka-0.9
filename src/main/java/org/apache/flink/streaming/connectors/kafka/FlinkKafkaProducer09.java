...
//     *             {@link #FlinkKafkaProducer091(String, SerializationSchema, Properties, FlinkKafkaPartitioner)} instead.
//     */
//    @Deprecated
//    public FlinkKafkaProducer091(String topicId, SerializationSchema<IN> serializationSchema, Properties producerConfig, KafkaPartitioner<IN> customPartitioner) {
//        this(topicId, new KeyedSerializationSchemaWrapper<>(serializationSchema), producerConfig, customPartitioner);
//    }
...
//     * @deprecated This is a deprecated constructor that does not correctly handle partitioning when
//     *             producing to multiple topics. Use
//     *             {@link #FlinkKafkaProducer091(String, KeyedSerializationSchema, Properties, FlinkKafkaPartitioner)} instead.
//     */
//    @Deprecated
//    public FlinkKafkaProducer091(String topicId, KeyedSerializationSchema<IN> serializationSchema, Properties producerConfig, KafkaPartitioner<IN> customPartitioner) {
